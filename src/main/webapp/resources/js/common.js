...
(function($) {
   ...
   menuAnimation:function()
   {
      ...
      else
      {
          ...
          // $(".nim-menu.navbar-default .navbar-nav > li > a").css("color","white");
          ...
          // $(".nim-menu.navbar-default .navbar-nav > li > a").hover(function(){$(this).css("color",themecolor)},function(){$(this).css("color","white")})
      }
       }
       )
   },
 ...
 var fullscreenslider=function()
  {
	...
	delay: 3000,
    slides: [
        { src: "resources/images/bak3.jpg" },
        { src: "resources/images/bak2.jpg" },
        { src: "resources/images/bak3.jpg" },
        { src: "resources/images/bak4.jpg" }
    ],animation: 'kenburns'
});
  }