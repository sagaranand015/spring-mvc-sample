			...
			jQuery(window).scroll(function() {
				if(window.width > 768) {
					...
					if(_scrollTop > _topBar_H) {
						...
						// to change the image in navbar header
						jQuery('#logo-image').fadeOut(100, function() {
							jQuery('#logo-text-image').fadeIn(300);
						});
						...
						// to change the image in navbar header
						jQuery('#logo-text-image').fadeOut(100, function() {
							jQuery('#logo-image').fadeIn(300);
						});
